...
function Ye(e2, t2, n2) {
  ...
  var C2, I2 = new ie(n2, g2, o2 ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      }(s3, r2, y2, true ? e4.warnTooManyClasses : void 0), w2 = n3, _2 = g3.$as || t4.$as || g3.as || t4.as || p2, N2 = ke(_2), A3 = g3 !== t4 ? v({}, t4, {}, g3) : t4, C3 = {};
      for (var I3 in A3)
        I3[0] !== "$" && I3 !== "as" && (I3 === "forwardedAs" ? C3.as = A3[I3] : (d3 ? d3(I3, is_prop_valid_browser_esm_default, _2) : !N2 || is_prop_valid_browser_esm_default(I3)) && (C3[I3] = A3[I3]));
  ...
  }, s2 && (0, import_hoist_non_react_statics.default)(C2, e2, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true, withComponent: true }), C2;
}
var qe = function(e2) {
...
function $e(e2) {
  ...
  var s2 = Ae.apply(void 0, [e2].concat(n2)), a2 = "sc-global-" + Te(JSON.stringify(s2)), u2 = new He(s2, a2);
  function l2(e3) {
    var t3 = fe(), n3 = me(), o3 = (0, import_react.useContext)(ze), l3 = (0, import_react.useRef)(t3.allocateGSInstance(a2)).current;
    return import_react.default.Children.count(e3.children) && console.warn("The global style component " + a2 + " was given child JSX. createGlobalStyle does not render children."), s2.some(function(e4) {
      return typeof e4 == "string" && e4.indexOf("@import") !== -1;
    }) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), (0, import_react.useLayoutEffect)(function() {
  ...
  function h2(e3, t3, n3, r2, o3) {
    if (u2.isStatic)
      ...
      u2.renderStyles(e3, i2, n3, o3);
    }
  }
  return Pe(a2), import_react.default.memo(l2);
}
function We(e2) {
...
var Je = function(e2) {
  var t2 = import_react.default.forwardRef(function(t3, n2) {
    var o2 = (0, import_react.useContext)(ze), s2 = e2.defaultProps, a2 = Oe(t3, o2, s2);
